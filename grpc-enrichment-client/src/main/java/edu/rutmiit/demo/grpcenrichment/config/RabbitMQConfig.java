...
public class RabbitMQConfig {
    ...
    public static final String ENRICHMENT_QUEUE = "q.enrichment.match-goal-scored";
    public static final String ENRICHMENT_DLQ = "q.enrichment.match-goal-scored.dlq";
    ...
    public Binding enrichmentBinding(Queue enrichmentQueue, TopicExchange eventsExchange) {
        return BindingBuilder
                ...
                .to(eventsExchange)
                .with(RoutingKeys.MATCH_GOAL_SCORED); // только book.created
    }
